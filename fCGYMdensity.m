function  f  = fCGYMdensity(r,q,sigma,t,T,C,G,Y,M,m,k1,k2,J,x  )
...
%r,q,sigma,t,T,C,G,Y,M are the parameters of the CGYM dynamics
...
for k=k1:k2
    ...
    for jp=0:(2^(J-1))
        cmk = cmk+fCGYM ( r,q,sigma,t,T,C,G,Y,M,(2*jp+1)*pi*2^m/2^J)*exp(2*pi*1i*k*jp/2^J);
    end
